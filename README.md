...
Also, unix style pipes are supported over kafka topics (experimentally), such as ["use topics to pipe ls to sort reverse to tr lower case to upper case"](https://github.com/yglcode/chat-kafka/blob/main/examples/pipe_thru_kafka.gpt).
